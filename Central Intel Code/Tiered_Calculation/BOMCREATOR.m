function [BOM,Gbom,BOM_fullRequirements,GBom_fullRequirements] = BOMCREATOR()
...
GBom_fullRequirements = digraph(inv(eye(size(BOM)) - BOM)',Gbom.Nodes.Name);
GBom_fullRequirements.Nodes.rawMaterials = Gbom.Nodes.rawMaterials;
GBom_fullRequirements.Nodes.FG = Gbom.Nodes.FG;

[s,t]=findedge(GBom_fullRequirements);
BOM_fullRequirements = full(sparse(s,t,GBom_fullRequirements.Edges.Weight,numnodes(GBom_fullRequirements),numnodes(GBom_fullRequirements)))';
end