...
userData_popup =struct('nt',nt,'nloc',nloc,'coordinates',coordinates);%All variables necessary for updating plot (T, Z, W, etc.)
...
userData_popup.coordinates = coordinates;
